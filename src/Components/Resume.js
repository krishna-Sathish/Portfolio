...
const Resume= () => {
  ...
  />
            ...
            <div className='md:w-1/2  flex justify-center'>
                 ...
                 <p className='text-white my-3'>Feel free to view my <strong>Resume</strong><a href={config.link} target='_blank' rel="noopener noreferrer" className='btn ms-32 md:ms-2'>Download</a> </p>
