  ...
  return (
    <section className=' flex flex-col md:flex-row bg-gray-950 px-5'>
            <div className='md:w-1/2 py-5 flex justify-end'>
                 <img className=' my-3 w-[300px]' src='https://image.lexica.art/full_webp/32b18dcd-ee11-427a-9e04-24a50bb31642' alt='about-img'/>
            </div> 
            <div className='md:w-1/2  flex justify-center'>
                 ...
                 <p className='text-white mt-3'>Feel free to view my <strong>Resume</strong><a href='/dow' className='btn ms-2'>Download</a> </p>
